...
from lighteval.community_tasks.multilingual.tasks.mqa.m_mmlu import M_MMLUTask, Meta_MMLUTask, Openai_MMLUTask
from lighteval.community_tasks.multilingual.tasks.mqa.m3lu import M3LU_TASK
