...
#LANGS = Literal["en", "ar", "zh", "ru", "fr", "hi", "te", "de"]
MLMM_LANGS = Literal["ar", "bn", "ca", "da", "de", "es", "eu", "fr", "gu", "hi", "hr", "hu", "hy", "id", "it", "kn", "ml", "mr", "ne", "nl", "pt", "ro", "ru", "sk", "sr", "sv", "ta", "te", "uk", "vi", "zh"]
...
def get_mlmm_tasks(lang: MLMM_LANGS):
...
def get_mlmm_tasks_nolang():
    return lambda lang: get_mlmm_tasks(lang)
