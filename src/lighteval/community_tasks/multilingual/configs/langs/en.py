...
from lighteval.community_tasks.multilingual.tasks.mqa.meta_mmlu import get_meta_mmlu_tasks
...
# TODO: Put back first list when errors are fixed
#_TASKS_LIST = [MlqaTask, XquadTask, TydiqaTask, get_mlmm_tasks, LambadaTask, XStoryClozeTask, XWinogradeTask, XCopaTask, XNLITask, PawnsXTask, M3ExamTask, BelebeleTask, MintakaTask, XCSQATask, XCODAHTask]
_TASKS_LIST = [MlqaTask, XquadTask, TydiqaTask, LambadaTask, XStoryClozeTask, XWinogradeTask, XNLITask, PawnsXTask, M3ExamTask, BelebeleTask, MintakaTask, XCSQATask, XCODAHTask]

_TASKS_DICT = build_tasks_per_group(_TASKS_LIST, 'en')
