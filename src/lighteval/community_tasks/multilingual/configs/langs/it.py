...
_TASKS_LIST = [get_mlmm_tasks, LambadaTask, XCopaTask, M3ExamTask, BelebeleTask, MintakaTask, XCSQATask, XCODAHTask]

_TASKS_DICT = build_tasks_per_group(_TASKS_LIST, 'it')
