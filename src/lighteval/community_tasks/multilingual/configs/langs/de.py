...
_TASKS_LIST = [MlqaTask, XquadTask, get_mlmm_tasks, LambadaTask, XNLITask, PawnsXTask, BelebeleTask, MintakaTask, XCSQATask, XCODAHTask]

_TASKS_DICT = build_tasks_per_group(_TASKS_LIST, 'de')
